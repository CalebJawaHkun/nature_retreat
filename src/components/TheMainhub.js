...
function ActivityWindow({activityObj}) {
    ...
    let {playClick, playSelect} = useSound();
...
export default function Main_Hub({showBoundary=false}) {
    ...
    let [activities, updateActs] = useState([
        new Activity('Gardening', new XY(400, 300), '/act_garden'),
        new Activity('Reflection', new XY(500, 600), '/act_diary'),
        new Activity('Meditation', new XY(1100, 400), '/act_med'),
        new Activity('Breathing Exercise', new XY(1200, 800), '/act_breath')
    ]);
